...
#       6.按下'Ctrl+S'可以修改文本标签栏，依次在工作、情感、疫情、生活、学业、考研、感情间切换
...
#           其中Job可以被替换为Life、Emotion、Epidemic、Study、Feeling、PostGraduate
...
class MainWindow(QWidget):
    ...
    def event_next_click(self):
        ...
        while self.next_line < self.total_line:
            # *1.换帖行
            if content[:10] == '----------' and len(content) >= 45:
